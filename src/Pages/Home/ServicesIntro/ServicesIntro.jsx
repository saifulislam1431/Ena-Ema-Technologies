...
<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center gap-9 my-14'>

<div className='bg-primary bg-opacity-20 rounded-lg px-5 py-4 flex flex-col justify-center items-center h-80'>
