...
<div className="hero my-16" style={{backgroundImage: `url(${abstractBg}) `}}>
  ...
  <div className="hero-content text-center">
    <div className="my-6">
      <h1 className="mb-5 text-3xl font-bold brandFont">How Ena Ema Technologies Works</h1>
      <p className="mb-5 font-medium">Cultivating Quality Through Agile Excellence: Choose Your web Outsourcing Model, and We'll Elevate Your Core Competencies to Propel Your Success in the Digital Landscape. Partner with Ena Ema Technologies for Unmatched Expertise and Innovation.</p>

      <div className='my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-center'>
<div className='bg-white px-3 py-4 rounded-xl hover:shadow-md hover:shadow-primary h-fit text-left'>
